print("ilovemath".isalpha())#checking for letters(cant do any spaces)
print("middleschoolsucks245243857436".isalnum())#checking for letters and numbers(also no spaces)
